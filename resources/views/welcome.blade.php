		...
		<div class="wrapper" id="home">
			...
			<div class="banner">
				<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner" role="listbox">
						...
						<div class="item">
							<img src="{{ asset('front/img/banner/b2.jpg') }}" alt="...">
							<div class="container">
								<!-- banner caption -->
					...
					<div class="hero-playlist">
						<div class="row">
							<div class="col-md-6 col-sm-6">
								...
								<div class="figure">
									<!-- image -->
									<img class="img-responsive" src="{{ asset('front/img/album/1.jpg') }}" alt="" />
									<!-- disk image -->
									<img class="img-responsive disk" src="{{ asset('front/img/album/disk.png') }}" alt="" />
								</div>
								<!-- album details -->
					...
					@foreach ($artist as $data )
						...
						<div class="col-md-4 col-sm-6">
								<div class="featured-item ">
									...
									<div class="figure">
										<!-- image -->
										<img class="img-responsive" src="{{ asset('images/'.$data -> image_path) }}" alt="" style="margin:0 auto;" height="100">
										<!-- paragraph -->
									</div>
									...
									<div class="featured-item-info">
										...
										<p>{{ $data->price }} <span class="label label-theme">Price</span> &nbsp;&nbsp; {{ $data->date }}+ <span class="label label-theme">Date</span></p>
									</div>
								</div>
							</div>
							@endforeach
			...
			<div class="portfolio pad" id="portfolio">
				...
				@foreach ($artist as $data )
					...
					<div class="item">
						<!-- item image -->
						<img class="img-responsive" src="{{ asset('images/'.$data->image_path) }}" alt="">
				...
				@endforeach
					...
					<div class="item">
						<!-- item image -->
						<img class="img-responsive" src="{{asset('front/img/portfolio/2.jpg') }}" alt="">
						<!-- transparent background -->
						<div class="p-transparent"></div>
						<!-- on mouse hover details -->
						<div class="p-hover">
					...
					<div class="item">
						<!-- item image -->
						<img class="img-responsive" src="{{ asset('front/img/portfolio/3.jpg') }}" alt="">
						<!-- transparent background -->
						<div class="p-transparent"></div>
						<!-- on mouse hover details -->
						<div class="p-hover">
					...
					<div class="item">
						<!-- item image -->
						<img class="img-responsive" src="{{ asset('front/img/portfolio/4.jpg') }}" alt="">
						<!-- transparent background -->
						<div class="p-transparent"></div>
						<!-- on mouse hover details -->
						<div class="p-hover">
					...
					<div class="item">
						<!-- item image -->
						<img class="img-responsive" src="{{ asset('front/img/portfolio/5.jpg') }}" alt="">
						<!-- transparent background -->
						<div class="p-transparent"></div>
						<!-- on mouse hover details -->
						<div class="p-hover">
					...
					<div class="item">
						<!-- item image -->
						<img class="img-responsive" src="{{ asset('front/img/portfolio/6.jpg') }}" alt="">
						<!-- transparent background -->
						<div class="p-transparent"></div>
						<!-- on mouse hover details -->
						<div class="p-hover">
					...
					<div class="item">
						<!-- item image -->
						<img class="img-responsive" src="{{ asset('front/img/portfolio/7.jpg') }}" alt="">
						<!-- transparent background -->
						<div class="p-transparent"></div>
						<!-- on mouse hover details -->
						<div class="p-hover">
					...
					<div class="item">
						<!-- item image -->
						<img class="img-responsive" src="{{ asset('front/img/portfolio/8.jpg') }}" alt="">
						<!-- transparent background -->
						<div class="p-transparent"></div>
						<!-- on mouse hover details -->
						<div class="p-hover">
							...
							<div class="col-md-6 col-sm-6">
								...
								<div class="events-item ">
									...
									<div class="figure">
										...
										<!-- image -->
										<img class="img-responsive" src="{{asset('front/img/event/1.jpg') }}" alt="" />
										<!-- image hover -->
										<div class="img-hover">
											<!-- hover icon -->
							...
							<div class="col-md-6 col-sm-6">
								...
								<div class="events-item ">
									...
									<div class="figure">
										...
										<!-- image -->
										<img class="img-responsive" src="{{ asset('front/img/event/2.jpg') }}" alt="" />
										<!-- image hover -->
										<div class="img-hover">
											<!-- hover icon -->
											<a href="#"><i class="fa fa-play-circle"></i></a>
							...
							<div class="row">
								<div class="col-md-3 col-sm-6">
									...
									<div class="team-member  delay-one">
										...
										<div class="member-img">
											<!-- Image  -->
											<img class="img-responsive" src="{{ asset('front/img/user/1.jpg') }}" alt="" />
											<!-- Hover block -->
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="team-member  delay-two">
										...
										<div class="member-img">
											<!-- Image  -->
											<img class="img-responsive" src="{{ asset('front/img/user/2.jpg') }}" alt="" />
											<!-- Hover block -->
											<div class="social text-center">
												<a href="#"><i class="fa fa-facebook"></i></a>
												<a href="#"><i class="fa fa-google-plus"></i></a>
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="team-member  delay-three">
										...
										<div class="member-img">
											<!-- Image  -->
											<img class="img-responsive" src="{{ asset('front/img/user/3.jpg') }}" alt="" />
											<!-- Hover block -->
											<div class="social text-center">
												<a href="#"><i class="fa fa-facebook"></i></a>
												<a href="#"><i class="fa fa-google-plus"></i></a>
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="team-member  delay-four">
										...
										<div class="member-img">
											<!-- Image  -->
											<img class="img-responsive" src="{{ asset('front/img/user/4.jpg') }}" alt="" />
											<!-- Hover block -->
											<div class="social text-center">
												<a href="#"><i class="fa fa-facebook"></i></a>
												<a href="#"><i class="fa fa-google-plus"></i></a>
			...
			<div class="meet parallax-four pad" id="meet">
				<div class="container">
					...
					<!-- meet location image -->
					<div class="meet-map">
						<img class="img-responsive img-map" src="{{ asset('front/img/flat/map.png') }}" alt="" />
